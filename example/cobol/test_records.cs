...
public class GeneratorModelTests {
  ...
  [Test]
  public void BasicRecordWithStringValue() {
    this.testSingleSentence(
      "01 SOME-FIELD PIC X(16) VALUE 'abc'.",
      new BasicRecord() {
        Level = new Int() { Value = "01" },
        LevelName = new LevelName() {
          HasFiller = false,
        ...
        Options = new List<Option>() {
          ...
          new ValueOption() {
            HasIs = false,
            Value = new String() { NextString = "abc" }
          }
        }
      }
    );
  ...
  [Test]
  public void BasicRecordWithSpaces() {
    this.testSingleSentence(
      "01 SOME-FIELD PIC X(16) VALUE SPACES.",
      new BasicRecord() {
        Level = new Int() { Value = "01" },
        LevelName = new LevelName() {
          HasFiller = false,
